/**
 * Program  : JsonUtils.java
 * Author   : misery
 * Create   : 2013-4-8 下午3:47:22
 */
...
public class JsonUtils {  
    ...
    /** 
     * 将给定的目标对象转换�?{@code JSON} 格式的字符串�?strong>此方法只用来转换普�?�?{@code JavaBean} 
     * 对象�?/strong> 
     * <ul> 
    ...
    public static <T> T fromJson(String json, TypeToken<T> token,  
        ...
        try {  
        	...
        	logger.error(json + " 无法转换�?" + token.getRawType().getName() + " 对象!",  
                    ex);  
            return null;  
        }  
    }  
    ...
    public static <T> T fromJson(String json, Class<T> clazz, String datePattern) {  
        ...
        try {  
        	...
        	logger.error(json + " 无法转换�?" + clazz.getName() + " 对象!", ex);  
            return null;  
        }  
    }  
