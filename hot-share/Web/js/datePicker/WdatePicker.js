...
(function () {
	...
	function D($) {
		...
		if ($dp && $dp.cal && !$dp.eCont && $dp.dd && _ != $dp.el && $dp.dd.style.display == "block") {
			$dp.cal.close();
		}
	}
	function Y() {
